...
the [WordsGeneratorApplication.kt](course://wordsGeneratorServer/wordsGeneratorServerHowToRun) file:

<img src="../../utils/src/main/resources/images/run/words_generator_run.png" alt="How to run the game" width="500">

Please don't forget to _stop all other runs_ by pressing the red square button:

<img src="../../utils/src/main/resources/images/stop/words_generator_stop.png" alt="How to stop the game" width="500">
...
<img src="../../utils/src/main/resources/images/main/words_generator.png" alt="The main page of the game" width="500">
